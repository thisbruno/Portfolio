<template>
    <v-container fluid fill-height class="home-hero" style="max-height: 100vh;">
        ...
        <v-btn flat round to='/about' large class="orange lighten-3 black--text "> Explore my work  <v-icon right>work</v-icon></v-btn>
        <v-btn round to='/contact' large class="orange lighten-3 black--text"> Hire Me  <v-icon right>person</v-icon></v-btn>
